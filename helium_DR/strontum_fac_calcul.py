...
# It is important to include mixing of the 
...
catch_shell=10##>9 not workin beacause no dr possible 


for i in range (3,catch_shell+1):
    fac.Config('d','1s1 2*1 %s*1'%(i))
fac.Config('d','1s1 2*2')


for i in range (2,catch_shell+1):
    fac.Config('f','1s2 %s*1'%(i))
